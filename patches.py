...
def install_studio():
    ...
    response = requests.get("https://setup.rbxcdn.com/mac/RobloxStudio.dmg", stream=True, allow_redirects=True, headers={'User-Agent': "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_8_2) AppleWebKit/537.17 (KHTML, like Gecko) Chrome/24.0.1309.0 Safari/537.17"})
    ...
    installer_process = Popen("/Volumes/RobloxStudioInstaller/RobloxStudioInstaller.app/Contents/MacOS/RobloxStudioInstaller")
